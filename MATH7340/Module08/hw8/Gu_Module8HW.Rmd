...
```
The mean gene expression value among B3 patients is $6.8102-0.1249=$`r 6.8102-0.1249`.
...
The p-value here is `r permutation.test("1242_at", c("B1", "B2", "B3"))` which is greater than 0.05.
